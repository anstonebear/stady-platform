				...
				<div className={style.header_wrapper}>
					<div className={style.header_left}>
						...
						<nav className={style.header_menu}>
							...
							<Link to='/courses' className={style.header_menu_link}>
								Курсы
							</Link>
							<Link to='/aboutus' className={style.header_menu_link}>
								О нас
							</Link>
							<Link to='/pricing' className={style.header_menu_link}>
								Цены
							</Link>
							<Link to='/contacts' className={style.header_menu_link}>
								Контакты
							</Link>
						</nav>
					</div>
